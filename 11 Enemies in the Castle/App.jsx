    ...
    <div className="wrapper">
      <div className="meadow-container">
        <div className="castle-container">
          ...
          {/* {initialEnemyData.map((enemy) => {
            const { id, currentImage, position, orientation } = enemy
            return (
              <Enemy
          ...
          <Enemy
            currentImage={initialEnemyData[0].currentImage}
            position={initialEnemyData[0].position}
            orientation={initialEnemyData[0].orientation}
          />
